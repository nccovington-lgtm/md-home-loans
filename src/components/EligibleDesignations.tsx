const designations = [
  ...
  {
    abbr: "CRNA",
    full: "Cert. Registered Nurse Anesthetist",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 15a9.065 9.065 0 0 1-6.23-.693L5 14.5m14.8.8 1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0 1 12 21a48.31 48.31 0 0 1-8.135-.687c-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
      </svg>
  ...
  {
    abbr: "Residents",
    full: "Residents, Fellows & Interns",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function EligibleDesignations() {
  return (
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-14">
          <p className="section-label text-teal mb-3">Who Qualifies</p>
          <h2 className="font-serif text-2xl sm:text-4xl text-navy mb-4">Eligible Designations</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
          {designations.map((d) => (
            <div
              key={d.abbr}
              className="bg-background border border-border border-l-4 p-3 sm:p-5 hover:shadow-md transition-shadow duration-200 group"
              style={{ borderRadius: "2px", borderLeftColor: "#2E7D6B" }}
            >
              <div className="text-teal mb-2">{d.icon}</div>
              <div className="font-serif text-navy font-bold text-lg sm:text-xl leading-tight mb-0.5">{d.abbr}</div>
              <div className="text-muted text-xs leading-snug">{d.full}</div>
            </div>
          ))}
        </div>
        ...
        <p className="text-center text-muted text-sm mt-10">
          ...
          <a href="#contact" className="text-teal hover:text-navy underline underline-offset-2 transition-colors">
